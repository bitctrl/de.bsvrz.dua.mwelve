...
SET jar=de.bsvrz.dua.mwelve-runtime.jar
...
CHCP 1252
TITLE Messwertersetzung LVE
java %jvmArgs% ^
de.bsvrz.dua.mwelve.vew.VerwaltungMessWertErsetzungLVE ^
-debugLevelStdErrText=info ^
-debugSetLoggerAndLevel=:config ^
-datenverteiler=%dav1Host%:%dav1AppPort% ^
-benutzer=%benutzer% ^
-authentifizierung=%passwortDatei% ^
-KonfigurationsBereichsPid=kb.duaMweTest
