...
//	public static final String WURZEL = ".\\res\\testDaten\\V_2.7.9(05.04.08)" + File.separator; //$NON-NLS-1$
	...
	// ".\\res\\testDaten\\V_2.7.9(05.04.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.7.6(01.04.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.7.3(20.03.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.7.2(12.03.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.7.1(05.03.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.7(20.02.08)\\"; //$NON-NLS-1$
	// public static final String WURZEL =
	// ".\\res\\testDaten\\V_2.2(14.01.08)\\"; //$NON-NLS-1$
	 ...
	 *             falls die Verbindung nicht hergestellt werden konnte
	 */
	public static IVerwaltung getVerwaltung() throws Exception {
